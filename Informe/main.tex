...
Para evaluar el modelo se empleó QuUANTO, un dataset de elaboración propia que
contiene afirmaciones derivadas de pares de pregunta-respuesta extraídos de
QuALES y validadas mediante revisión humana. QuALES fue una tarea de Question
Answering extractivo en español organizada en IberLEF 2022 y basada en noticias
uruguayas sobre la pandemia de COVID-19 y temas relacionados~\cite{rosa2022}.
Las afirmaciones para la evaluación se tomaron del archivo \code{QuUANTO\_unified\_final.json}. 
